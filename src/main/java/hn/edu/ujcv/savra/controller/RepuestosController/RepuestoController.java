package hn.edu.ujcv.savra.controller.RepuestosController;

import hn.edu.ujcv.savra.entity.Repuesto.Repuesto;
import hn.edu.ujcv.savra.exceptions.BusinessException;
import hn.edu.ujcv.savra.exceptions.NotFoundException;
import hn.edu.ujcv.savra.service.RepuestosService.RepuestoService.RepuestoService;
...
public class RepuestoController {
    ...
    @PostMapping("/addRepuesto/{stockA}/{stockM}/{stockMa}/{precio}")
    public ResponseEntity<Object> addRepuesto(@RequestBody Repuesto repuesto,
                                              @PathVariable boolean stockA,
                                              @PathVariable boolean stockM,
                                              @PathVariable boolean stockMa,
                                              @PathVariable double precio) {
        try {
            service.saveRepuesto(repuesto, stockA, stockM, stockMa, precio);
    ...
    @PutMapping("/{stockA}/{stockM}/{stockMa}/{precio}")
    public ResponseEntity<Any> updateRepuesto(@RequestBody Repuesto repuesto,
                                              ...
                                              @PathVariable double precio) {
        try {
            service.updateRepuesto(repuesto, stockA, stockM, stockMa, precio);
